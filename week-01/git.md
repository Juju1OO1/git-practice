...
### - Blob  
又稱為 Binary large object，一種物件類型，每當新增一   
...
版本有哪些 tree 物件、以及提交時間、message 等等，通常還     
會記錄上一層的 commit 物件名稱。

### - Branch
git 中的分支機制，最主要的目的就是用來解決開發過程中版本衝    
突的問題，當協作開發時常發生一個 issue 同時多人進行的狀   
...
### rm --cached 從 git 暫存區中移除，但是檔案還在工作目錄   
1. Index > 紀錄更動     
...
## Subject 主旨
不應超過 50 個字元，若用英文書寫則需大寫開頭，中英文都不用句號結尾。
盡量以祈使句書寫，言簡意賅的簡述此 Commit 的改動。
...
為 mac OS 之 finder 目錄檔案，不建議 push 到 repo 上    
